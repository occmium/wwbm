...
RSpec.describe GamesController, type: :controller do
  ...
  context 'Usual user' do
    ...
    # Задача 63-4 — khsm: тест на GamesController#help
    # Напишите тест на GamesController, который проверяет, что пользователь
    # может воспользоваться подсказкой 50/50.
